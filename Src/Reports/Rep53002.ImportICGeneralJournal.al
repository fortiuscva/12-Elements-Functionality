report 53002 "12E Import IC General Journal"
{
    ...
    begin
        ...
        GenJournalTemplate.TestField(Type, GenJournalTemplate.Type::Intercompany);
        ...
        FOR i := FirstRow TO LastRow DO
            ...
            if tempExcelBuf.GET(i, 1) then begin  //posting date has value
                ...
                if (DebitAmount <> 0) or (creditamount <> 0) or (Amount <> 0) then begin
                    ...
                    IF tempExcelBuf.GET(i, 11) THEN                             //bal account type
                        IF (tempExcelBuf."Cell Value as Text" <> '') THEN BEGIN
                            EVALUATE(GenJournalLine."bal. Account Type", tempExcelBuf."Cell Value as Text");
                            GenJournalLine.VALIDATE("bal. Account Type");
                        END;

                    IF (tempExcelBuf.GET(i, 12)) THEN                             //bal account no.
                        IF (tempExcelBuf."Cell Value as Text" <> '') THEN
                            GenJournalLine.VALIDATE("bal. Account No.", tempExcelBuf."Cell Value as Text");

                    IF (tempExcelBuf.GET(i, 13)) THEN                             //IC account type
                        IF (tempExcelBuf."Cell Value as Text" <> '') THEN BEGIN
                            EVALUATE(GenJournalLine."IC Account Type", tempExcelBuf."Cell Value as Text");
                            GenJournalLine.VALIDATE("IC Account Type");
                        END;

                    IF (tempExcelBuf.GET(i, 14)) THEN                             //IC account no.
                        IF (tempExcelBuf."Cell Value as Text" <> '') THEN
                            GenJournalLine.VALIDATE("IC Account No.", tempExcelBuf."Cell Value as Text");

                    IF (tempExcelBuf.GET(i, 15)) THEN                             //system entry
                        IF (tempExcelBuf."Cell Value as Text" <> '') THEN
                            GenJournalLine.validate("reason code", tempExcelBuf."Cell Value as Text");

                    //Add shortcut Dimension Entries, only if specified...
                    FOR j := 1 TO 8 DO
                        IF tempExcelBuf.GET(i, j + 15) THEN
                            IF (tempExcelBuf."Cell Value as Text" <> '') THEN BEGIN
    ...
    begin
        ...
        tempExcelBuf.AddColumn(GenJournalLine.FIELDCAPTION("IC Account Type"), FALSE, '', TRUE, FALSE, TRUE, '', tempExcelBuf."Cell Type"::Text);
        tempExcelBuf.AddColumn(GenJournalLine.FIELDCAPTION("IC Account No."), FALSE, '', TRUE, FALSE, TRUE, '', tempExcelBuf."Cell Type"::Text);
        ...
        tempExcelBuf.AddColumn('', FALSE, '', FALSE, FALSE, FALSE, '', tempExcelBuf."Cell Type"::Text);
        tempExcelBuf.AddColumn('', FALSE, '', FALSE, FALSE, FALSE, '', tempExcelBuf."Cell Type"::Text);
        tempExcelBuf.AddColumn('G/L Account', FALSE, '', FALSE, FALSE, FALSE, '', tempExcelBuf."Cell Type"::Text);
        tempExcelBuf.AddColumn('XXXXXX', FALSE, '', FALSE, FALSE, FALSE, '', tempExcelBuf."Cell Type"::Text);
        tempExcelBuf.AddColumn('', FALSE, '', FALSE, FALSE, FALSE, '', tempExcelBuf."Cell Type"::Text);
        tempExcelBuf.AddColumn('', FALSE, '', FALSE, FALSE, FALSE, '', tempExcelBuf."Cell Type"::Text);
        tempExcelBuf.AddColumn('', FALSE, '', FALSE, FALSE, FALSE, '', tempExcelBuf."Cell Type"::Text);
        tempExcelBuf.AddColumn('', FALSE, '', FALSE, FALSE, FALSE, '', tempExcelBuf."Cell Type"::Text);
        tempExcelBuf.AddColumn('', FALSE, '', FALSE, FALSE, FALSE, '', tempExcelBuf."Cell Type"::Text);
        tempExcelBuf.AddColumn('IC Partner', FALSE, '', FALSE, FALSE, FALSE, '', tempExcelBuf."Cell Type"::Text);
        tempExcelBuf.AddColumn('XXXXXX', FALSE, '', FALSE, FALSE, FALSE, '', tempExcelBuf."Cell Type"::Text);
        tempExcelBuf.AddColumn('G/L Account', FALSE, '', FALSE, FALSE, FALSE, '', tempExcelBuf."Cell Type"::Text);
        tempExcelBuf.AddColumn('XXXXXX', FALSE, '', FALSE, FALSE, FALSE, '', tempExcelBuf."Cell Type"::Text);


        tempExcelBuf.CreateNewBook('ICGenJnl');
        tempExcelBuf.WriteSheet('ICGenJnl', CompanyName, UserId);
        tempExcelBuf.CloseBook();
        TempExcelBuf.SetFriendlyFilename('ICGenJnlLoadTemplate');
