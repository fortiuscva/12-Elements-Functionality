codeunit 52117 "12E Payroll Release Mgmt"
{
    ...
    begin
        if PayrollHeader."Batch Status" = PayrollHeader."Batch Status"::Released then
    ...
    begin
        if PayrollHeader."Batch Status" <> PayrollHeader."Batch Status"::Open then
            Error('Only Open Call Center Distribution documents can be released. Document %1 skipped.', PayrollHeader."No.");

        PayrollHeader."Batch Status" := PayrollHeader."Batch Status"::Released;
    ...
    begin
        ...
        PayrollHeader."Batch Status" := PayrollHeader."Batch Status"::Open;
        PayrollHeader.Modify(true);
    end;
